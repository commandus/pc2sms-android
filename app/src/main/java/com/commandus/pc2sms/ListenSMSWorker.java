...
public class ListenSMSWorker extends Worker {
    private Pc2Sms pc2Sms;
    private static final String TAG = ListenSMSWorker.class.getSimpleName();

    public ListenSMSWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
